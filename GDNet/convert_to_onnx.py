...
model = GDNet()
model.load_state_dict(torch.load("GDNet/200.pth"))
# model = MirrorNet()
...
ort_session = onnxruntime.InferenceSession("/home/ayush/OptiDepth/model_gdnet.onnx") #providers=["CPUExecutionProvider"]
